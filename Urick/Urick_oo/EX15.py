...
bichinho = Tamagushi('Julio')
bichinho.alt_Nome('Julio')
bichinho.alt_Fome(9)
bichinho.alt_Saude(5)
bichinho.alt_Idade(10)
bichinho.DarComida(50)
bichinho.brincar(8)

print('Nome:',bichinho.Nome)
print(bichinho.Fome,'de fome')
print(bichinho.Saude,'de saúde')
print(bichinho.Idade,'anos')
print('O bichinho',bichinho.CheckHumor())