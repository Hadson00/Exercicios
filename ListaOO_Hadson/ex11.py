class Carro:
    ...
    def pode_andar(self, kilometragem):  
    ...
    def andar(self, km): 
        if (self.pode_andar(km)):
            ...
            print (f'Combustível insuficiente para andar {km}')

    def tanque(self): 
        print(f"Restam {self.__combustivel_no_tanque} litros no tanque de combustível")
